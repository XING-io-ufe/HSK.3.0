...
function InputField({ label, placeholder, type = "text", icon }: InputFieldProps) {
    return (
        <div>
...
function TabButton({ label, active, onClick }: TabButtonProps) {
    return (
        <button
            type="button"
            onClick={onClick}
            className={`flex-1 py-4 text-center text-sm sm:text-base font-semibold transition-all border-b-2 border-transparent ${active
                ...
                <div className="w-full max-w-2xl">
                    <div className="glass-card relative overflow-hidden rounded-2xl bg-black/30 shadow-2xl">
                        <div className="flex border-b border-white/5 bg-black/30">
                            <TabButton
                                label={t(lang, 'navLogin')}
                                tab="login"
                                active={activeTab === "login"}
                                onClick={() => setActiveTab("login")}
                            />
                            <TabButton
                                label={t(lang, 'authSignupCta')}
                                tab="signup"
                        ...
                        <div className="p-8">
                            {activeTab === "login" && (
                                <div className="space-y-8">
                                    <div className="text-center">
                                        <h2 className="mb-2 text-2xl font-bold">{t(lang, 'authWelcomeTitle')}</h2>
                                        <p className="text-sm text-gray-400">
                                            {t(lang, 'authWelcomeSubtitle')}
                                        </p>
                                    </div>

                                    <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                                        <InputField
                                            label={t(lang, 'authEmailPhone')}
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-2 flex justify-end">
                                                <Link className="text-xs text-primary transition-colors hover:text-white" href="/forget-password">
                                                    {t(lang, 'authForgot')}
                                                </Link>
                                            </div>
                                        </div>
                                    ...
                                    <div className="relative text-sm text-gray-500">
                                        ...
                                        <div className="relative flex justify-center">
                                            <span className="bg-[#121212] px-2">{t(lang, 'authOr')}</span>
                                        </div>
                                    </div>
                            ...
                            {activeTab === "signup" && (
                                <div className="space-y-8">
                                    <div className="text-center">
                                        <h2 className="mb-2 text-2xl font-bold">{t(lang, 'authSignupTitle')}</h2>
                                        <p className="text-sm text-gray-400">
                                            {t(lang, 'authSignupSubtitle')}
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3 rounded-lg border border-primary/20 bg-primary/10 p-4">
                                        ...
                                        <div className="text-xs leading-relaxed text-gray-200">
                                            <strong className="mb-1 block text-white">{t(lang, 'authPaymentTitle')}</strong>
                                            {t(lang, 'authPaymentBody')}
                                        </div>
                                    </div>
                                    ...
                                    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                                        ...
                                        />
                                        <InputField
                                            label={t(lang, 'authPasswordConfirm')}
                                            placeholder="••••••••"
                                            type="password"
                                        ...
                                        <div className="pt-2">
                                            ...
                                            >
                                                <span>{t(lang, 'authSignupCta')}</span>
                                                <MdArrowForward size={20} />
                                            </button>
                                        </div>
                                    </form>
