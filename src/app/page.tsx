...
const Countdown = dynamic(() => import('@/components/features/countdown/Countdown'), { ssr: false });
...
export default function HomePage() {
    ...
    return (
        <div className="bg-background text-white overflow-x-hidden selection:bg-primary selection:text-black">
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                <main className="grow flex flex-col items-center w-full">
                    ...
                    {/* Programs */}
                    <section className="w-full py-20 relative bg-background">
