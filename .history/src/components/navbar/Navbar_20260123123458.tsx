                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        <div className="flex items-center gap-2">
                            <div className="h-8 w-8 rounded overflow-hidden bg-primary flex items-center justify-center">
                                <Image src="/logo.png" alt="Hanzi.mn" width={32} height={32} className="object-cover" />
                            </div>
