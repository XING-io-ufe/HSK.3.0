                ...
                <main className="flex-grow flex flex-col items-center w-full">
                    ...
                    <section className="relative w-full py-20 lg:py-32 overflow-hidden">
                        <div className="container mx-auto px-4 flex flex-col items-center text-center max-w-5xl">
                            ...
                            <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.1] mb-6 text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-gray-500">
                        ...
                        <div className="container mx-auto px-4 max-w-6xl relative z-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                                ...
                                <div className="glass-card rounded-2xl p-6 border border-white/5 relative overflow-hidden group hover:border-white/20 transition-all duration-300 hover:scale-[1.02] bg-[#1a1a1a]">
                                    ...
                                    <button className="w-full h-10 rounded-lg border border-white/10 text-gray-500 font-medium text-sm cursor-not-allowed flex items-center justify-center gap-2 bg_BLACK/20">
                                        Түгжигдсэн
                                    </button>
                                </div>
                                ...
                                <div className="glass-card rounded-2xl p-6 border border-white/5 relative overflow-hidden group hover:border-white/20 transition-all duration-300 hover:scale-[1.02] bg-[#1a1a1a]">
                                    ...
                                    <div className="flex items-center gap-4 mb-6 opacity-60 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text_WHITE">HSK 4</h3>
                                ...
                                <div className="glass-card rounded-2xl p-6 border border-white/5 relative overflow-hidden group hover:border-white/20 transition-all duration-300 hover:scale-[1.02] bg-[#1a1a1a]">
                                    ...
                                    <div className="flex items-center gap-4 mb-6 opacity-60 group-hover:opacity-100 transition-opacity">
                                        <div className="h-12 w-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify_center text-white">
                            ...
                            <div className="w-full glass-card rounded-2xl p-8 border border-primary/30 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 group">
                                ...
                                <div className="flex items-center gap-6 relative z-10">
                                    <div className="h-16 w-16 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center shadow-lg shadow-yellow-500/20 shrink-0">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-stretch justify-center">
                                <div className="flex-1 glass-card rounded-2xl p-8 relative overflow-hidden group hover:border-primary/50 transition-colors duration-300">
                                    ...
                                    <div className="flex justify-between items-start mb-6">
                                        <div>
                                            <h3 className="text-2xl font-bold text_white mb-1">HSK 2.0</h3>
                                ...
                                <div className="flex-1 glass-card rounded-2xl p-8 relative overflow-hidden border-red-500/10 hover:border-red-500/30 transition-colors duration-300">
                                    ...
                                    <ul className="space-y-4 mb-8">
                                        ...
                                        <li className="flex items-start gap-3">
                                            <span className="material-symbols-outlined text-red-400 text-[20px] mt-0.5">close</span>
                                            <span className="text-gray-400 text_sm">Орчуулгын хүнд даалгаварууд нэмэгдэнэ</span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <span className="material-symbols-outlined text-red-400 text-[20px] mt-0.5">close</span>
                    ...
                    <section className="w-full py-20 relative overflow-hidden border-t border-white/5">
                        <div className="absolute inset-0 bg-primary/5 opacity-50 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary/10 via-transparent to-transparent"></div>
