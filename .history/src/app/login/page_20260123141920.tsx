                                                ...
                                                {!showForgot ? (
                                                    ...
                                                    <div className="w-full max-w-xs">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="name@example.com"
                                                            className="mb-2 block w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder-gray-500 focus:border-primary focus:outline-none"
                                                        />
                                                        <div className="flex gap-2 justify-end">
                                                            ...
                                                            <button
                                                                ...
                                                                className="rounded-md bg-primary px-3 py-1 text-sm font-semibold text-black hover:brightness-105"
                                                            >
                                                                Илгээх
                                                            </button>
                                                        </div>
                                                        {resetSent && (
                                                            <p className="mt-2 text-sm text-green-400">Нууц үг сэргээх заавар таны имэйл рүү илгээгдлээ.</p>
                                                        )}
                                                    </div>
                                                )}
                                            </div>
