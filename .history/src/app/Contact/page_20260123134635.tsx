                            ...
                            <div className="glass-card p-8 md:p-10 rounded-2xl border border-white/10 relative overflow-hidden">
                                ...
                                <form className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea className="w-full bg-surface-dark border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-primary neon-input transition-all duration-300 min-h-37.5" id="message" placeholder="Таны асуулт эсвэл санал..." />
                                    </div>
