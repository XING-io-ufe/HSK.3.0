    ...
    return (
        <div className="bg-background-dark text-white overflow-x-hidden selection:bg-primary selection:text-black">
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                <main className="flex-grow flex flex-col items-center w-full py-12 lg:py-20">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                            <div className="lg:col-span-7 flex flex-col gap-6">
                                <div className="glass-card p-1 rounded-3xl border border-white/10 relative group h-full">
                                    <div className="absolute -inset-0.5 bg-gradient-to-br from-primary/30 to-blue-600/30 rounded-3xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
                                    <div className="relative bg-[#0F0F0F] rounded-[22px] p-8 h-full flex flex-col justify-between overflow-hidden">
                                        ...
                                        <div className="flex-grow flex justify-center items-center py-6 relative z-10">
