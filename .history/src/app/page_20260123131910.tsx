< !DOCTYPE html >
  <html class="dark" lang="mn"><head>
    ...
    <title>Холбоо барих - Hanzi.mn Support</title>
    ...
    <style>
      ...
      .neon-input:focus {
        box - shadow: 0 0 15px rgba(19, 236, 37, 0.2);
      border-color: #13ec25;
        }
      .neon-text-glow {
    ...
    <body class="bg-background-dark text-white overflow-x-hidden selection:bg-primary selection:text-black">
      ...
      <div class="relative z-10 flex flex-col min-h-screen">
          ...
          <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
              ...
              <nav class="hidden md:flex items-center gap-8">
                ...
                <a class="text-sm font-medium text-primary transition-colors" href="#">Холбоо барих</a>
              </nav>
        ...
        <main class="flex-grow flex flex-col items-center justify-center w-full min-h-[calc(100vh-64px-150px)]">
          <section class="w-full py-16 lg:py-24 relative">
            <div class="container mx-auto px-4 max-w-6xl">
              <div class="text-center mb-16">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">Холбоо барих</h1>
                <p class="text-xl md:text-2xl text-primary font-medium tracking-wide neon-text-glow opacity-90">
                  Бид Монгол хүмүүстээ туслахад бэлэн
                </p>
                <div class="h-1 w-24 bg-primary mx-auto mt-6 rounded-full opacity-50"></div>
              </div>
              <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                <div class="lg:col-span-7">
                  <div class="glass-card p-8 md:p-10 rounded-2xl border border-white/10 relative overflow-hidden">
                    ...
                    <form class="space-y-6">
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                          <label class="block text-sm font-medium text-gray-400 pl-1" for="name">Нэр</label>
                          <input class="w-full bg-surface-dark border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-primary neon-input transition-all duration-300" id="name" placeholder="Таны нэр" type="text" />
                        </div>
                        <div class="space-y-2">
                          <label class="block text-sm font-medium text-gray-400 pl-1" for="email">Имэйл</label>
                          <input class="w-full bg-surface-dark border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-primary neon-input transition-all duration-300" id="email" placeholder="name@example.com" type="email" />
                        </div>
                      </div>
                      <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-400 pl-1" for="subject">Сэдэв</label>
                        <select class="w-full bg-surface-dark border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-primary neon-input transition-all duration-300 appearance-none">
                      ...
                      <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-400 pl-1" for="message">Зурвас</label>
                        <textarea class="w-full bg-surface-dark border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-primary neon-input transition-all duration-300 min-h-[150px]" id="message" placeholder="Таны асуулт эсвэл санал..."></textarea>
                      </div>
                      <button class="w-full py-4 rounded-lg bg-primary text-black font-bold text-base hover:bg-white transition-all transform hover:scale-[1.01] neon-glow flex items-center justify-center gap-2 mt-4" type="button">
                        <span>ИЛГЭЭХ</span>
                ...
                <div class="lg:col-span-5 flex flex-col space-y-8 py-4">
                  <div>
                    <h3 class="text-2xl font-bold text-white mb-4">Мэдээлэл</h3>
                  ...
                  <div class="space-y-5">
                    <div class="group flex items-start gap-5 p-5 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] hover:border-primary/30 transition-all duration-300">
                      <div class="bg-primary/10 p-3 rounded-lg text-primary group-hover:scale-110 transition-transform">
                        <span class="material-symbols-outlined">alternate_email</span>
                      </div>
                      <div>
                        <p class="text-xs text-gray-500 uppercase tracking-widest font-semibold mb-1">Хамтын ажиллагаа</p>
                        <a class="text-lg text-white font-medium hover:text-primary transition-colors" href="mailto:tselmeg@yargait.com">
                          tselmeg@yargait.com
                        </a>
                      </div>
                    </div>
                    <div class="group flex items-start gap-5 p-5 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] hover:border-primary/30 transition-all duration-300">
                      ...
                      <div>
                        <p class="text-xs text-gray-500 uppercase tracking-widest font-semibold mb-1">Тусламж &amp; Дэмжлэг</p>
                        <a class="text-lg text-white font-medium hover:text-primary transition-colors" href="mailto:tushig@yargait.com">
                          tushig@yargait.com
                        </a>
                      </div>
                    </div>
                    <div class="group flex items-start gap-5 p-5 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] hover:border-primary/30 transition-all duration-300">
                      ...
                      <div>
                        <p class="text-xs text-gray-500 uppercase tracking-widest font-semibold mb-1">Байршил</p>
                        <span class="text-lg text-gray-300 font-medium">
                          Улаанбаатар хот, Монгол Улс
                        </span>
                      </div>
                    </div>
                  </div>
                  <div class="pt-8 mt-4 border-t border-white/10 flex gap-6">
                    <a class="text-gray-500 hover:text-primary transition-colors hover:scale-110 transform" href="#">
